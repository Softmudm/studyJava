        ...
        <form id="selform" action="/selectUserServlet" method="post">
          <div class="form-group pull-right">
            <div class="col-sm-9">
              ...
              <button class="btn btn-primary col-sm-3" type="submit">查询</button>
          </div>
        </form>
        <table class="table table-hover table-bordered table-striped text-center">
          ...
          <c:forEach items="${list}" var="user">
            <tr>
              ...
              <td>${user.rolename}</td>
              <td>
                <button class="btn btn-success" onclick="update('${user.userid}','${user.username}','${user.rolename}')">修改</button>
